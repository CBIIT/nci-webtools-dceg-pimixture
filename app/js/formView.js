appMixture.FormView = Backbone.View.extend({
    ...
    initializePopovers: function() {
        ...
        this.$('#modelPopover').popover({title: "Parametric, weakly-parametric, semiparametric",
            ...
            trigger:"focus", container:"body", html: true});
        this.$('#strataPopover').popover({title: "Strata", content: 'When you choose "weighted data" in "Sample Design", this means that the data set you\'ll use is stratified random samples with different sampling fractions across strata. Strata variable can be continuous or categorical.',  trigger:"focus", container:"body", html: true});
        this.$('#weightPopover').popover({title: "Weight", content: 'When you choose "weighted data" in "Sample Design", this means that the data set you\'ll use is stratified random samples with different sampling fractions across strata. Sampling weight variable should be continuous. The sampling weights within each stratum is identical, and it is calculated by the inverse of sampling fraction, where the sampling fraction for stratum j is n_j/N_j, and  n_j and  N_j are the sample size and stratum size, respectively.',  trigger:"focus", container:"body", html: true});
